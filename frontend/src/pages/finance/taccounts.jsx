...
const ViewAccountingDetails = () => {
  ...
  useEffect(() => {
    axios
      .get("https://erp-system-nexeyo.herokuapp.com/account/TotalSales/get", {
  ...
  useEffect(() => {
    axios
      .get(
        "https://erp-system-nexeyo.herokuapp.com/account/TotalPurchases/get",
        {
          withCredentials: true,
          credentials: "include",
        }
  ...
  useEffect(() => {
    axios
      .get("https://erp-system-nexeyo.herokuapp.com/account/TotalEPF/get", {
        withCredentials: true,
        credentials: "include",
      })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("https://erp-system-nexeyo.herokuapp.com/account/TotalETF/get", {
        withCredentials: true,
        credentials: "include",
      })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://erp-system-nexeyo.herokuapp.com/account/TotalNetSalary/get",
        {
          withCredentials: true,
          credentials: "include",
        }
  ...
  useEffect(() => {
    axios
      .get(
        "https://erp-system-nexeyo.herokuapp.com/account/TotalGrossSalary/get",
        {
          withCredentials: true,
          credentials: "include",
        }
  ...
  useEffect(() => {
    axios
      .get("https://erp-system-nexeyo.herokuapp.com/account/TotalAdvance/get", {
        withCredentials: true,
        credentials: "include",
      })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://erp-system-nexeyo.herokuapp.com/account/TotalEPFCompany/get",
        {
          withCredentials: true,
          credentials: "include",
        }
